...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bazta.Identity.Domain.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("Bazta.Identity.Domain.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Bazta.Identity.Domain.Entities.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("Bazta.Identity.Domain.Entities.AppUserRole", b =>
                {
                    b.HasOne("Bazta.Identity.Domain.Entities.AppRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Bazta.Identity.Domain.Entities.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Bazta.Identity.Domain.Entities.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bazta.Identity.Domain.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
